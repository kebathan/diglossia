...
def finetune_xlm_roberta(
    ...
    tokenizer.save_pretrained(path, push_to_hub=True, repo_name=f"aryaman/{model_name}-irumozhi")
    model.save_pretrained(path, push_to_hub=True, repo_name=f"aryaman/{model_name}-irumozhi")
    return cr
